...
class gnuSA(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "gnuSA")
        ...
        self.soapy_rtlsdr_source_0.set_frequency(0, 500e6)
...
def main(top_block_cls=gnuSA, options=None):
